...
if __name__ == '__main__' :
  ...
  ws3.append(styled_cells(ws3,["Package Name", "Table Name", "Column Name", "Code", "DataType", "Length", "Mandatory?"]))
...
#   print("P:", pkg_attrs[ws = wb.create_sheet()"Name"],pkg_attrs["Code"],pkg_attrs["Creator"])
    ...
    for tbl in PDMHandler.getTblNodesInPkg(pkg) :
      ...
      for col in PDMHandler.getColNodesInTbl(tbl) :
        ...
        ws3.append([pkg_attrs["Name"], tbl_attrs["Name"], col_attrs["Name"],col_attrs["Code"],col_attrs["DataType"],col_attrs["Length"], col_attrs["Column.Mandatory"]])
      ...
      for idx in PDMHandler.getIdxNodesInTbl(tbl) :
        ...
        ws4.append([pkg_attrs["Name"], tbl_attrs["Name"], idx_attrs["Name"],idx_attrs["Code"],idx_attrs["Unique"]])
